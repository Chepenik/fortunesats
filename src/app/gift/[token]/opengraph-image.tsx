...
export default async function OGImage({
  ...
  const colors = OG_RARITY_COLORS[gift.rarity];
      ...
      >
        ...
        <div
          style={{
            ...
            height: 250,
            borderRadius: "50%",
            background: "radial-gradient(circle, rgba(212,162,87,0.06) 0%, transparent 70%)",
            bottom: "-8%",
            left: "50%",
            transform: "translateX(-50%)",
          }}
        ...
        <div
          style={{
            ...
            width: 100,
            height: 1,
            background: "linear-gradient(90deg, transparent, rgba(212,162,87,0.35), transparent)",
          }}
        />
        ...
        >
          ...
          >
            {RARITY_LABELS[gift.rarity]} GIFT
          </span>
        </div>

        {/* Gift icon */}
        <div style={{ fontSize: 64, marginBottom: 24, opacity: 0.9 }}>
          🎁
        </div>
